...
export function Home({ products }: HomeProps) {
  ...
  const lifestyle = [
    ...
    },
    {
      ...
      image: "https://timcindynailbar.com/uploads/fnail0bg5wepy/product/thumbnail/1425915-w576.jpg",
      description: "Add charm to everyday moments"
    },
    {
      id: 3,
      title: "Special Events",
      image: "https://quarrynailsbar.com/wp-content/themes/quarrynailbar/images/abs-2.jpg",
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-rose-400 to-pink-400 text-white rounded-full hover:shadow-xl hover:scale-105 transition-all duration-300"
                >
                  Shop Trending Nails
                </button>
                <button
                  ...
                  className="px-8 py-4 bg-white text-gray-700 rounded-full hover:shadow-xl hover:scale-105 transition-all duration-300 border border-gray-200"
                >
                  Explore Collections
                </button>
              </div>
              ...
              {currentProducts.map((product, index) => (
                ...
                >
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <button
                      onClick={() => navigate(`/product/${createSlug(product.name)}`)}
                      className="w-full py-3 bg-gradient-to-r from-rose-400 to-pink-400 text-white rounded-full hover:shadow-lg transition-all duration-300 hover:scale-105"
                    >
                      View Product
                    </button>
                  </div>
